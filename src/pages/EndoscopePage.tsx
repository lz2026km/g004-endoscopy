// @ts-nocheck
// ============================================================
// G004 内镜管理系统 - 内镜设备管理页面
// 增强：内镜全生命周期（位置/状态/使用记录/维护预警）
// ============================================================
...
const mockUseRecords: UseRecord[] = [
  { id: 'UR001', endoscopeId: 'EN001', patientName: '王建国', patientId: 'P001', examType: '电子胃镜检查', doctorName: '张建国', nurseName: '李娟', examRoom: '内镜室1', examDate: '2026-04-29', examTime: '09:00', endTime: '09:25', findings: '慢性浅表性胃炎，胃溃疡（S2期）', status: '已完成' },
  { id: 'UR002', endoscopeId: 'EN001', patientName: '李美华', patientId: 'P002', examType: '电子胃镜检查', doctorName: '张建国', nurseName: '李娟', examRoom: '内镜室1', examDate: '2026-04-28', examTime: '14:00', endTime: '14:30', findings: '食道炎，贲门松弛', status: '已完成' },
  { id: 'UR003', endoscopeId: 'EN001', patientName: '赵大力', patientId: 'P003', examType: '电子胃镜检查', doctorName: '周明', nurseName: '王芳', examRoom: '内镜室1', examDate: '2026-04-27', examTime: '10:30', endTime: '11:00', findings: '正常胃黏膜', status: '已完成' },
  { id: 'UR004', endoscopeId: 'EN001', patientName: '孙小燕', patientId: 'P004', examType: '电子胃镜检查', doctorName: '张建国', nurseName: '李娟', examRoom: '内镜室1', examDate: '2026-04-26', examTime: '15:00', endTime: '15:28', findings: '胃息肉（山田I型）', status: '已完成' },
  { id: 'UR005', endoscopeId: 'EN002', patientName: '周国强', patientId: 'P005', examType: '电子胃镜检查', doctorName: '周明', nurseName: '王芳', examRoom: '内镜室1', examDate: '2026-04-29', examTime: '10:30', endTime: '11:05', findings: '十二指肠溃疡', status: '已完成' },
  { id: 'UR006', endoscopeId: 'EN003', patientName: '吴婷', patientId: 'P006', examType: '电子结肠镜检查', doctorName: '张建国', nurseName: '李娟', examRoom: '内镜室2', examDate: '2026-04-28', examTime: '08:30', endTime: '09:15', findings: '结肠息肉（山田II型）', status: '已完成' },
  { id: 'UR007', endoscopeId: 'EN003', patientName: '郑伟', patientId: 'P007', examType: '电子结肠镜检查', doctorName: '周明', nurseName: '王芳', examRoom: '内镜室2', examDate: '2026-04-27', examTime: '14:00', endTime: '14:50', findings: '溃疡性结肠炎（活动期）', status: '已完成' },
  { id: 'UR008', endoscopeId: 'EN004', patientName: '陈静', patientId: 'P008', examType: '电子结肠镜检查', doctorName: '张建国', nurseName: '李娟', examRoom: '内镜室2', examDate: '2026-04-29', examTime: '08:00', endTime: '08:40', findings: '正常结肠黏膜', status: '已完成' },
];
...
const generateExtraEndoscopes = (base: Endoscope[]): Endoscope[] => {
  ...
  const names = [
    { name: 'Fujifilm电子胃镜', model: 'EL-7000', manufacturer: 'Fujifilm', category: '胃镜' },
    { name: 'Fujifilm电子结肠镜', model: 'EC-7000', manufacturer: 'Fujifilm', category: '肠镜' },
    { name: 'Pentax电子胃镜', model: 'EG-2990i', manufacturer: 'Pentax', category: '胃镜' },
    { name: 'Pentax电子结肠镜', model: 'EC-3890i', manufacturer: 'Pentax', category: '肠镜' },
    { name: 'Boston超声内镜', model: 'SU-9000', manufacturer: 'Boston Scientific', category: '超声内镜' },
  ...
  const locations = ['内镜室1', '内镜室2', '内镜室3', '内镜储存室', '内镜室1', '内镜室2']
      ...
      <div style={s.overviewStatRow}>
        <div style={s.overviewStatCard}>
          ...
          <div style={s.overviewStatInfo}>
            ...
            <div style={s.overviewStatSub}>内镜 {endoscopes.filter(e => ['胃镜','肠镜','支气管镜','十二指肠镜','超声内镜'].includes(e.category)).length} 台</div>
          </div>
        </div>
        <div style={s.overviewStatCard}>
        ...
        <div style={s.overviewStatCard}>
          ...
          <div style={s.overviewStatInfo}>
            ...
            <div style={s.overviewStatLabel}>洗消中</div>
      ...
      {paged.length === 0 ? (
        <div style={{ ...s.table, padding: '40px 0' }}>
          <div style={s.emptyState}>
            ...
            <div style={s.emptyTitle}>暂无内镜设备</div>
            <div style={s.emptyDesc}>当前没有符合条件的内镜设备，请检查筛选条件或添加新设备</div>
        ...
        <div style={s.overlay} onClick={e => e.target === e.currentTarget && closeModal()}>
          <div style={s.modal}>
            ...
            {modalMode === 'view' && viewingEndoscope && (() => {
              ...
              <>
                <div style={s.modalHeader}>
                  <div style={s.modalTitle}>内镜设备详情</div>
            ...
            {(modalMode === 'add' || modalMode === 'edit') && (
              <>
                <div style={s.modalHeader}>
                  <div style={s.modalTitle}>{modalMode === 'add' ? '新增内镜设备' : '编辑内镜设备'}</div>
                  <button style={s.modalClose} onClick={closeModal}><X size={18} /></button>
                </div>
                <div style={s.modalBody}>
                  {formErrors.length > 0 && (
                  ...
                  <div style={s.formGrid}>
                    ...
                    <div style={s.formGroup}>
                      ...
                      >
                        ...
                        <option value="十二指肠镜">十二指肠镜</option>
